  ...
  const sections = [
    ...
    },
    {
      ...
      fields: [
        ...
        { name: "otherProductsRxSBUD", label: "Other Products Rx SBUD" },
    ...
    },
    {
      ...
      fields: [
        { name: "SBUDOrderRouteName", label: "SBU D Order Route Name", type: "text" },
        { name: "noOfPartySBUDOrderRoute", label: "No Of Party SBU D Order Route" },
        { name: "noOfCollectedOrderSBUD", label: "No Of Collected Order SBU D" },
