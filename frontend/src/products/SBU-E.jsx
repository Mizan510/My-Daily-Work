  ...
  const sections = [
    ...
    // ================= Rx Section =================
    {
      ...
      fields: [
        ...
        {
          name: "sbueRxWithoutBasketAndNewProductRx",
          label: "SBU-E Rx Without Basket And New Product Rx",
          readOnly: true,
        },
    ...
    // ================= Order Section =================
    {
      ...
      fields: [
        {
          name: "sbueOrderRouteName",
          label: "SBU E Order Route Name",
          type: "text",
        },
        {
          name: "noOfPartySbueOrderRoute",
          label: "No Of Party SBU E Order Route",
        },
        {
          name: "noOfCollectedOrderSbue",
          label: "No Of Collected Order SBU E",
        },
        {
    ...
    // ================= Strategic Basket Orders =================
    {
      ...
      fields: [
        ...
        { name: "iracetOrder", label: "Iracet Order" },
        { name: "neumigOrder", label: "Neumig Order" },
        { name: "methomolOrder", label: "Methomol Order" },
      ],
    },
    ...
    // ================= Focus Basket Orders =================
    {
      ...
      fields: [
        { name: "angilockOrder", label: "Angilock Order" },
        { name: "angilockPlusOrder", label: "Angilock Plus Order" },
        { name: "neurolinOrder", label: "Neurolin Order" },
        { name: "epitraOrder", label: "Epitra Order" },
        { name: "anclogOrder", label: "Anclog Order" },
      ],
    },
    ...
    // ================= Emerging Basket Orders =================
    {
      ...
      fields: [
        { name: "nebitaOrder", label: "Nebita Order" },
        { name: "telmilokOrder", label: "Telmilok Order" },
        { name: "camlotelOrder", label: "Camlotel Order" },
        { name: "minibetOrder", label: "Minibet Order" },
        { name: "qtpOrder", label: "QTP Order" },
      ],
    },
