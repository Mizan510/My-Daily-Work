  ...
  const sections = [
...

    {
      ...
      fields: [
        ...
        { name: "noOfPartySbucOrderRoute", label: "No. of Party" },
        { name: "noOfCollectedOrderSbuc", label: "Collected Orders" },
        {
...

    {
      ...
      fields: [
        { name: "neuroBOrder", label: "Neuro B Order" },
        { name: "calboralDDXOrder", label: "Calboral D/DX Order" },
        { name: "toraxOrder", label: "Torax Order" },
        { name: "aceAceplusOrder", label: "Ace / Ace Plus Order" },
      ],
    },

    {
      ...
      fields: [
        { name: "zimaxOrder", label: "Zimax Order" },
        { name: "calboDOrder", label: "Calbo D Order" },
        { name: "anadolAnadolplusOrder", label: "Anadol / Anadol Plus Order" },
      ],
    },

    {
      ...
      fields: [
        { name: "safyronOrder", label: "Safyron Order" },
        { name: "dBalanceOrder", label: "D-Balance Order" },
        { name: "tezoOrder", label: "Tezo Order" },
        {
          name: "contilexContilexTSOrder",
          label: "Contilex / Contilex TS Order",
        },
        { name: "maxrinMaxrinDOrder", label: "Maxrin / Maxrin D Order" },
      ],
    },
