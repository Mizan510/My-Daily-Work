...
const InputFormA = () => {
  ...
  const fetchReports = async () => {
    try {
      const res = await axios.get(
        "https://my-daily-work.onrender.com/api/form-dataa"
      );
  ...
  const handleSubmit = async (e) => {
    ...
    for (let field of numericFields) {
      const value = Number(FormDataA[field]);
    ...
    try {
      await axios.post("https://my-daily-work.onrender.com/api/form-dataa", {
        ...FormDataA,
        userName: loggedInUser,
      });
      toast.success("Report submitted successfully!"); // <-- Custom toast
      setFormDataA(initialState); // Reset form
